...
#                else:
#                    price = round((float(sheet2.cell(i, 12).value) + delta), 1)
#                    sheet.cell(row , 16).value = price
#            except:
#                pass
#
...
#        write_info(cell_date, 11, today()[1] ,ws=sheet_price1)
#    except Exception as e:
#        print(e)
##-----------------------------------------------------------------------------------------------------    
#def main():
